...
public class PythonParser extends PythonParserBase {
	...
	public final Simple_stmtsContext simple_stmts() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				simple_stmt();
				setState(472);
				if (!(is_notNextToken(';'))) throw new FailedPredicateException(this, "is_notNextToken(';')");
				setState(473);
				match(NEWLINE);
				}
				break;
	...
	public final Del_stmtContext del_stmt() throws RecognitionException {
		...
		try {
			...
			del_targets();
			setState(588);
			if (!(isNextToken(SEMI, NEWLINE))) throw new FailedPredicateException(this, "isNextToken(SEMI, NEWLINE)");
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final With_itemContext with_item() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				star_target();
				setState(807);
				if (!(isNextToken(',', ')', ':'))) throw new FailedPredicateException(this, "isNextToken(',', ')', ':')");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	public final Func_type_commentContext func_type_comment() throws RecognitionException {
		...
		try {
			...
			case NEWLINE:
				...
				match(TYPE_COMMENT);
				setState(1177);
				if (!(areNextTokens(NEWLINE, INDENT))) throw new FailedPredicateException(this, "areNextTokens(NEWLINE, INDENT)");
				}
				break;
			case TYPE_COMMENT:
				enterOuterAlt(_localctx, 2);
	...
	public final Target_with_star_atomContext target_with_star_atom() throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				match(NAME);
				setState(2174);
				if (!(is_notNextToken(t_lookahead))) throw new FailedPredicateException(this, "is_notNextToken(t_lookahead)");
				}
				break;
			case 2:
				enterOuterAlt(_localctx, 2);
	...
	private T_primaryContext t_primary(int _p) throws RecognitionException {
		...
		try {
			...
			atom();
			setState(2267);
			if (!(isNextToken(t_lookahead))) throw new FailedPredicateException(this, "isNextToken(t_lookahead)");
			}
			_ctx.stop = _input.LT(-1);
			setState(2292);
			_errHandler.sync(this);
	...
	private boolean del_stmt_sempred(Del_stmtContext _localctx, int predIndex) {
		switch (predIndex) {
		case 2:
			return isNextToken(SEMI, NEWLINE);
		}
		return true;
	}
	...
	private boolean func_type_comment_sempred(Func_type_commentContext _localctx, int predIndex) {
		switch (predIndex) {
		case 11:
			return areNextTokens(NEWLINE, INDENT);
		}
		return true;
	}
	...
	private boolean target_with_star_atom_sempred(Target_with_star_atomContext _localctx, int predIndex) {
		switch (predIndex) {
		case 48:
			return is_notNextToken(t_lookahead);
		case 49:
			return is_notNextToken(t_lookahead);
		}
		return true;
	...
	private boolean t_primary_sempred(T_primaryContext _localctx, int predIndex) {
		switch (predIndex) {
		case 54:
			return isNextToken(t_lookahead);
		case 55:
			return precpred(_ctx, 5);
		case 56:
			return isNextToken(t_lookahead);
